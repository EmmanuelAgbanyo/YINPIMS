            ...
            {mode === 'email_signin' && (
              <>
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center space-x-3 rounded-2xl border-2 border-[#14595A]/30 bg-white px-5 py-3.5 text-sm font-bold text-[#1C1C1A] hover:bg-[#FAFAF9] hover:border-[#14595A] transition-all shadow-sm hover:shadow-md cursor-pointer disabled:opacity-50 group"
                >
                  ...
                  <span className="group-hover:text-[#14595A] transition-colors">Sign in with Google</span>
                </button>

                <p className="text-[11px] text-center text-[#6B6B66] -mt-1">
                  New users signing in with Google are assigned roles directly by the Super Administrator.
                </p>
